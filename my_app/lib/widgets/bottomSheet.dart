...
class Modal {
  mainBottomSheet(BuildContext context) {
    showModalBottomSheet(
      ...
      builder: (BuildContext context) {
        TextEditingController customerController = TextEditingController(text: "Transaction");
        TextEditingController phoneController = TextEditingController(text: "1234567890");
        TextEditingController statueController = TextEditingController(text: "Approved");
        TextEditingController typeController = TextEditingController(text: "VISA");
        return Container(
                          ...
                          RaisedButton(
                            onPressed: () async {
                              ...
                              User newPost = new User (
                                ...
                                timestamp: "76543234567"
                              );
                              var abc = newPost.toMap();
                              print("abc");
                              print(abc);
                              User p = await createPost(
                                  body: abc);
                              print(p.customer);
                            },
  ...
  createTransactionForm(BuildContext context) {
    showDialog(
      context: context,
      builder: (BuildContext context) {
        TextEditingController customerController = TextEditingController(text: "Transaction");
